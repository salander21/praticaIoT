...
const char* ssid = "nomeRede"; //Aqui o nome da sua rede local wi fi
...
const int mqttPort = 24278; // Aqui mude para sua porta fornecida pelo site
const char* mqttUser = "wgeknnff"; //  Aqui o nome de usuario fornecido pelo site
const char* mqttPassword = "mSDI5uK5_-t3"; //  Aqui sua senha fornecida pelo site
//char EstadoSaida = '0';  
